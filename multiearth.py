...
start = "2000-02-25" # first date of the required dataset
end = "2023-02-10" # last date of the required dataset
    ...
    if (end >= start):
        ...
        if validDate(start, end, "2000-02-24", "2023-02-10"):
            ...
            modis = (
                ...
                .filterDate(start, end) # filter the date
                .sort("system:time_start", opt_ascending = False) # sort by date
                .select(["Nadir_Reflectance_Band1", "Nadir_Reflectance_Band4", "Nadir_Reflectance_Band3"]) # colour channels (2 for IR, 3 for blue, 6 for SWIR)
            )
